    ...
    public partial class Default6 : System.Web.UI.Page
    {
        ...
        public void LoadData()
        {
            ...
            {   
                ...
                ltrHotline.Text += "<p class=\"desc\"><a href=\"tel:" + confi.HotlineSupport + "\">" + confi.HotlineSupport + "</p>";
                ltrEmail.Text += "<p class=\"desc\"><a href=\"mailto:" + confi.EmailSupport + "\">" + confi.EmailSupport + "</a></p>";
                ltrTime.Text += "<p class=\"desc\"><a>" + confi.TimeWork + "</a></span>";
            }
            ...
            if (steps.Count > 0)
            {
                ...
                foreach (var item in steps)
                {
                    ...
                    if (count == 1)
                    {
                        ltrStep2.Text += "<div class=\"c-tab__item js-" + count + " active wow fadeInUp\" data-wow-delay=\".3s\" data-wow-duration=\"1s\">";
                    }
                    else
                    {
                    ...
                    if (!string.IsNullOrEmpty(item.StepLink))
                        ltrStep2.Text += "<a href=\"" + item.StepLink + "\" class=\"btn-main btn bg-yellow\">Đăng ký</a>";
                    ltrStep2.Text += "</div>";
                    ltrStep2.Text += "</div>";
                    count++;
                }
