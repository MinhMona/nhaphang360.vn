<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/NHAPHANG360.Master" CodeBehind="Default.aspx.cs" Inherits="NHST.Default6" %>
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <main class="main-wrap">
            ...
            <div class="container">
                <div class="content-main-banner">
                    ...
                    <div class="extension-setting wow fadeInRight" data-wow-delay=".8s" data-wow-duration="1s">
                        <div class="extension-item center">
                            <div class="btn-extension">
                                <a href="https://chrome.google.com/webstore/detail/c%C3%B4ng-c%E1%BB%A5-%C4%91%E1%BA%B7t-h%C3%A0ng-c%E1%BB%A7a-nh%E1%BA%ADp/cmemkbklahilgppdibhcgbejcpminkph" target="_blank" class="btn-main btn bg-brow"><i class="fa fa-chrome"></i>Chrome</a>
                                <a href="https://chrome.google.com/webstore/detail/c%C3%B4ng-c%E1%BB%A5-%C4%91%E1%BA%B7t-h%C3%A0ng-c%E1%BB%A7a-nh%E1%BA%ADp/cmemkbklahilgppdibhcgbejcpminkph" target="_blank" class="btn-main btn bg-brow"><i class="fa fa-chrome"></i>Cốc Cốc</a>
                            </div>
                            <div class="app-btn">
                                <a href="https://play.google.com/store/apps/details?id=com.appteamvn.FoxExpress" target="_blank" class="">
                                    <img src="/App_Themes/NH360/images/apple.png" /></a>
                                <a href="https://apps.apple.com/us/app/fox-express/id1500112357?ls=1" target="_blank" class="">
                                    <img src="/App_Themes/NH360/images/chplay.png" /></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="sec sec-search">
            <div class="container">
                <div class="main-title other">
                    <div class="row">
                        <div class="col col-4 col-m-0"></div>
                        <div class="col col-8 col-m-12">
                            <div class="search-title">
                                <div id="product" class="active">Tìm kiếm sản phẩm</div>
                                <p>- </p>
                                <div id="tracking">Tracking</div>
                            </div>
                            <%-- <p class="desc">You have finished building your own website. You have introduced your company and presented your products and services. You have added...</p>--%>
                            <div id="form-product" class="sec-search__form">
                                <div class="sec-search__box-1">
                                    <select name="taobao" class="sec-search__box-1--select" id="brand-source">
                                        <option value="taobao" selected>TAOBAO</option>
                                        <option value="tmall">TMALL</option>
                                        <option value="1688">1688</option>
                                    </select>
                                </div>
                                <div class="sec-search__box-2">
                                    <asp:TextBox type="text" runat="server" ID="txtSearch" class="sec-search__box-2--txt" placeholder="Nhập sản phẩm tìm kiếm"></asp:TextBox>
                                </div>
                                <a href="javascript:" onclick="searchProduct()" class="sec-search__form--btn">Tìm kiếm</a>
                                <asp:Button ID="btnSearch" runat="server"
                                    OnClick="btnSearch_Click" Style="display: none"
                                    OnClientClick="document.forms[0].target = '_blank';" UseSubmitBehavior="false" />
                            </div>
                            <div id="form-tracking" class="sec-search__form d-none">
                                <div class="sec-search__box-2 remove">
                                    <input type="text" id="txtMVD" class="sec-search__box-2--txt" placeholder="Nhập mã vận đơn">
                                </div>
                                <a href="javascript:;" onclick="searchCode()" class="sec-search__form--btn">Tìm kiếm</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="shipper">
                <img src="/App_Themes/NH360/images/shipper.png" alt="shipper">
            </div>
        </section>
                    ...
                    <div class="columns">
                        ...
                        <div class="colum center">
                            <div class="content-center wow fadeInUp" data-wow-delay=".4s" data-wow-duration="1s">
                                <div class="box-img">
                                    <img src="/App_Themes/NH360/images/img-video.png" alt="">
                ...
                <div class="table-benefits">
                    <div class="columns">
                        <div class="colum left wow zoomInLeft" data-wow-delay=".2s" data-wow-duration="1s">
                            <div class="box-img">
                                <img src="/App_Themes/NH360/images/thung.png" alt="">
                            </div>
                        </div>
        ...
        <section class="sec sec-contact">
            <div class="container isner">
                <div class="bg-map">
                    <img src="/App_Themes/NH360/images/map.png" alt="">
                    <div class="icon-check">
                        <img src="/App_Themes/NH360/images/check.png" alt="">
                    </div>
                </div>
                <div class="table-contact">
                    ...
                    <div class="box-contact box-contact--width wow zoomIn" data-wow-delay=".4s" data-wow-duration="1s">
                        <div class="row">
                            <div class="col col-6">
                        ...
                        <div class="cols">
                            <div class="col-4">
                                <div class="box-content8">
                                    <div class="col-6">
                                        <div class="img-nganhang">
                                            <img src="/App_Themes/NH360/images/viettinbank.png" alt="">
                                        </div>
                                    </div>
                                    <div class="col-6" style="padding: 0;">
                                        <div class="name">
                                            <h3>Nguyễn Văn Đông</h3>
                                            <p>STK : <span>107866680266</span></p>
                                            <p>Chi nhánh : <span>Hội Sở</span></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="box-content8">
                                    <div class="col-6">
                                        <div class="img-nganhang">
                                            <img src="/App_Themes/NH360/images/Vietcombank.png" alt="">
                                        </div>
                                    </div>
                                    <div class="col-6" style="padding: 0;">
                                        <div class="name">
                                            <h3>Nguyễn Văn Đông</h3>
                                            <p>STK : <span>0591000278032</span></p>
                                            <p>Chi nhánh : <span>Phố Nối</span></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="box-content8">
                                    <div class="col-6">
                                        <div class="img-nganhang">
                                            <img src="/App_Themes/NH360/images/techcombank.png" alt="">
                                        </div>
                                    </div>
                                    <div class="col-6" style="padding: 0;">
                                        <div class="name">
                                            <h3>Nguyễn Văn Đông</h3>
                                            <p>STK : <span>19031776645013</span></p>
                                            <p>Chi nhánh : <span>Ba Đình</span></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
