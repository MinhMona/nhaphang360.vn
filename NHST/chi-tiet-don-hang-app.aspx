<%@ Page Title="Chi tiết đơn hàng app" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true" CodeBehind="chi-tiet-don-hang-app.aspx.cs" Inherits="NHST.chi_tiet_don_hang_app" %>
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
            ...
            <asp:Panel ID="pnMobile" runat="server" Visible="false">
                <div class="page-body">
                    <div class="all donhang donhang_list">
                        <h2 class="title_page">CHI TIẾT ĐƠN HÀNG</h2>
            ...
            $.connection.hub.start().done(function () {
                $('#sendnotecomment').click(function () {
                    ...
                    if (commentext == "" || commentext == null) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "/chi-tiet-don-hang-app.aspx/PostComment",
    ...
    <style>
        ...
        .slide-up .item-slide .title-slide {
            width: 50%;
            padding: 5px 5px;
            border: 1px solid gray;
        }
         .slide-up .item-slide .txt-toggle {
            width: 50%;
            padding: 5px 5px;
            border: 1px solid gray;
        }
