...
namespace NHST
{
    public partial class NHAPHANG360 : System.Web.UI.MasterPage
    {
        ...
        public void LoadData()
        {
            ...
            if (confi != null)
            {
                ...
                ltrZalo1.Text += "<li class=\"rel-zalo\">";
                ltrZalo1.Text += "<div class=\"info-zalo\">";
                ltrZalo1.Text += "<p>Mr: Đông</p>";
                ltrZalo1.Text += "<span>NV Quản lý</span>";
                ltrZalo1.Text += "</div>";
                ltrZalo1.Text += "<div class=\"img-zalo\">";
                ltrZalo1.Text += "<a href =\"" + confi.ZaloLink + "\" target=\"_blank\"><img src=\"/App_Themes/NH360/images/zalo.png\" alt=\"\"></a>";
                ltrZalo1.Text += "</div>";
                ltrZalo1.Text += "</li>";

                //ltrZalo1.Text += "<li class=\"rel-zalo\">";
                //ltrZalo1.Text += "<div class=\"info-zalo\">";
                //ltrZalo1.Text += "<p>Mr: Trung</p>";
                //ltrZalo1.Text += "<span>NV CSKH</span>";
                //ltrZalo1.Text += "</div>";
                //ltrZalo1.Text += "<div class=\"img-zalo\">";
                //ltrZalo1.Text += "<a href =\"" + confi.ZaloLink2 + "\" target=\"_blank\"><img src=\"/App_Themes/NH360/images/zalo.png\" alt=\"\"></a>";
                //ltrZalo1.Text += "</div>";
                //ltrZalo1.Text += "</li>";               

                ltrZalo1.Text += "<li class=\"rel-zalo\">";
                ltrZalo1.Text += "<div class=\"info-zalo\">";
                ltrZalo1.Text += "<p>Mr: Sale<p>";
                ltrZalo1.Text += "<span>NV Sale</span>";
                ltrZalo1.Text += "</div>";
                ltrZalo1.Text += "<div class=\"img-zalo\">";
                ltrZalo1.Text += "<a href =\"" + confi.ZaloLink3 + "\" target=\"_blank\"><img src=\"/App_Themes/NH360/images/zalo.png\" alt=\"\"></a>";
                ltrZalo1.Text += "</div>";
                ltrZalo1.Text += "</li>";                

                ltrZalo1.Text += "<li class=\"rel-zalo\">";
                ltrZalo1.Text += "<div class=\"info-zalo\">";
                ltrZalo1.Text += "<p>HotLine</p>";
                ltrZalo1.Text += "<span>" + confi.Hotline + "</span>";
                ltrZalo1.Text += "</div>";
                ltrZalo1.Text += "<div class=\"img-zalo ic-phone-extra\">";
                ltrZalo1.Text += "<a href=\"tel:" + confi.Hotline + "\" target=\"_blank\"><img src=\"/App_Themes/NH360/images/phone.png\" alt=\"\"></a>";
                ltrZalo1.Text += "</div>";
                ltrZalo1.Text += "</li>";

                ltrZalo1.Text += "<li class=\"rel-zalo\">";
                ltrZalo1.Text += "<div class=\"info-zalo\">";
                ltrZalo1.Text += "<p>Messenger</p>";
                ltrZalo1.Text += "<span>Messenger</span>";
                ltrZalo1.Text += "</div>";
                ltrZalo1.Text += "<div class=\"img-zalo ic-phone-extra\">";
                ltrZalo1.Text += "<a href =\"" + confi.Twitter + "\" target=\"_blank\"><img src=\"/App_Themes/NH360/images/mess.png\" alt=\"\"></a>";
                ltrZalo1.Text += "</div>";
                ltrZalo1.Text += "</li>";


                //ltrZalo2.Text += "<li><a href=\"" + confi.ZaloLink2 + "\" target=\"_blank\"><img src=\"/App_Themes/NH360/images/zalo.png\" alt=\"\"></a></li>";
                //ltrZalo3.Text += "<li><a href=\"" + confi.ZaloLink3 + "\" target=\"_blank\"><img src=\"/App_Themes/NH360/images/zalo.png\" alt=\"\"></a></li>";
                //ltrZalo4.Text += "<li><a href=\"" + confi.ZaloLink4 + "\" target=\"_blank\"><img src=\"/App_Themes/NH360/images/zalo.png\" alt=\"\"></a></li>";
                //ltrZalo5.Text += "<li><a href=\"" + confi.ZaloLink5 + "\" target=\"_blank\"><img src=\"/App_Themes/NH360/images/zalo.png\" alt=\"\"></a></li>";
                ...
                ltrLogo.Text = "  <a href=\"/\"><img src=\"" + confi.LogoIMG + "\" alt=\"\" style=\"width: 100px;\"></a>";
